...
1. Find `JobSearchCoach-Install.zip`.
2. Right-click it and choose **Extract All** on Windows, or double-click it on Mac.
3. Move the extracted `JobSearchCoach-Install` folder somewhere easy to find, such
...
1. Open the `JobSearchCoach-Install` folder.
2. Double-click `Start JobSearchCoach.bat`.
3. A black command window will open.
4. Your browser should open to JobSearchCoach automatically.
