  ...
  function render() {
    ...
    el.innerHTML = `
      <style>
        ...
        .jtt-btn.alumni:hover, .jtt-btn.alumni.active { background: rgba(10,102,194,0.12); }
        .jtt-scan-all { border-color: #9D2235; color: #9D2235; margin-left: auto; }
        .jtt-scan-all:hover { background: rgba(157,34,53,0.08); }
